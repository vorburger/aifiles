...
The `gmail-pull.ts` script allows you to pull emails from Gmail based on a search filter and store them locally as YAML files, including attachments and body content.

## Usage

```bash
scripts/gmail-pull.ts "<gmail-filter>" <base_directory>
```

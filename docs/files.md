...
* `skills/` : Agent Skills following the [agentskills.io](https://agentskills.io) standard; each skill lives in its own sub-directory as a `SKILL.md` with YAML frontmatter

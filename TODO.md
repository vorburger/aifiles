...
- [ ] Make Jules take Code Review feedback comments from Copilot and Gemini Code Review into account and iterate on them?
      Ideally run them locally, first… are they available as a skill?
...
- [ ] Eval (some of the) skills, using [skill-creator](https://github.com/anthropics/skills/tree/main/skills/skill-creator), see https://agentskills.io/skill-creation/evaluating-skills.
